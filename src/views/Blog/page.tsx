...
export default function OurBlogs() {
  ...
  return (
    <Box className="w-full max-w-[1216px] h-full flex flex-col lg:flex-row gap-[32px] xl:gap-[67px]">
        ...
        {currentPageData?.map((blog, i) => {
          return (
            ...
            >
              <Image
                src={blog.src}
                className="w-full sm:w-[384px] h-full sm:h-[240px] rounded-[10px]"
                width={384}
                height={240}
                alt={blog.title}
              />
              <Box component="div" className="w-full flex gap-1 font-interSemibold font-semibold text-sm text-left text-primary ">
                <Box component="span">{blog.author}</Box>
                <Box component="span" className="text-[6px] mt-[2px]">&#x25CF;</Box>
                 <Box component="span">{blog.date}</Box>
              </Box>
              <Box component="div" className="w-full flex gap-1 font-interSemibold font-semibold text-xl text-left text-dark justify-between">
               {blog.title}
                <ArrowUp />
              </Box>
